...
The object of the following exercise is to introduce the concepts of parallel programming and parallel processing by turning your class or group into the components of a computer and implementing a simple program on them. 
...
Memory Sheet for Monte Carlo Pi:

https://github.com/suzannepk/Human-Supercomputer-/blob/gh-pages/MonteCarloMemorySheet.pdf

C coding tutorials for extending Monte Carol Pi to non-human computers:

https://www.olcf.ornl.gov/tutorials/monte-carlo-pi/

**Origami Rabbit Race**

You will need 20-50 sheets of origami paper or other paper that has been cut into a square. 
